...
macro_rules! c_debug {
    ($($arg:tt)*) => {
        println!("[S2BinLib001 Debug] {}", format!($($arg)*));
    };
}
...
macro_rules! get_s2binlib_mut {
    ($this:expr) => {{
        ...
        if s2binlib.is_none() {
            return_error!(-1, "S2BinLib001 is not initialized");
        }
        s2binlib.unwrap()
    }};
}
...
#[repr(C)]
pub struct S2BinLib001 {
    pub vtable: *const S2BinLib001VTable,
...
pub struct S2BinLib001VTable {
    ...
    pub clear_module_base_address:
        unsafe extern "C" fn(this: *mut S2BinLib001, binary_name: *const c_char) -> i32,
    ...
    pub is_binary_loaded:
        unsafe extern "C" fn(this: *const S2BinLib001, binary_name: *const c_char) -> i32,
    pub load_binary:
        unsafe extern "C" fn(this: *mut S2BinLib001, binary_name: *const c_char) -> i32,
    ...
    pub object_ptr_has_vtable:
        unsafe extern "C" fn(this: *const S2BinLib001, object_ptr: *const c_void) -> i32,
    ...
    pub dump_xrefs: unsafe extern "C" fn(this: *mut S2BinLib001, binary_name: *const c_char) -> i32,
    ...
    pub unload_binary:
        unsafe extern "C" fn(this: *mut S2BinLib001, binary_name: *const c_char) -> i32,
    pub unload_all_binaries: unsafe extern "C" fn(this: *mut S2BinLib001) -> i32,
    ...
    pub find_networkvar_vtable_statechanged_rva:
        unsafe extern "C" fn(this: *const S2BinLib001, vtable_rva: u64, result: *mut u64) -> i32,
    pub find_networkvar_vtable_statechanged: unsafe extern "C" fn(
        this: *const S2BinLib001,
        vtable_mem_address: u64,
        result: *mut u64,
    ) -> i32,
    pub destroy: unsafe extern "C" fn(this: *mut S2BinLib001) -> i32,
}

static VTABLE: S2BinLib001VTable = S2BinLib001VTable {
...
unsafe extern "C" fn LoadBinary(this: *mut S2BinLib001, binary_name: *const c_char) -> i32 {
    check_null!(this, binary_name);
...
unsafe extern "C" fn UnloadBinary(this: *mut S2BinLib001, binary_name: *const c_char) -> i32 {
    check_null!(this, binary_name);
...
unsafe extern "C" fn UnloadAllBinaries(this: *mut S2BinLib001) -> i32 {
    check_null!(this);
...
unsafe extern "C" fn Destroy(this: *mut S2BinLib001) -> i32 {
    check_null!(this);

    s2binlib001_destroy(this as *mut c_void);
    0
}

#[unsafe(no_mangle)]
pub extern "C" fn s2binlib001_create() -> *mut c_void {
    let s2binlib001 = Box::new(S2BinLib001::new());
    Box::into_raw(s2binlib001) as *mut c_void
}

fn s2binlib001_destroy(ptr: *mut c_void) {
    if !ptr.is_null() {
        unsafe {
            let _ = Box::from_raw(ptr as *mut S2BinLib001);
        }
    }
}
